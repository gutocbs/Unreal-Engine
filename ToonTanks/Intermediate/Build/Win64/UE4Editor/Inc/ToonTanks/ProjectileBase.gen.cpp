...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProjectileBase_Statics::NewProp_ProjectileMesh_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Components" },
		{ "Comment", "//Essa classe \xc3\xa9 importante para que o modelo do projetil siga o movimento\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Actors/ProjectileBase.h" },
		{ "ToolTip", "Essa classe \xc3\xa9 importante para que o modelo do projetil siga o movimento" },
	};
#endif
	...
	IMPLEMENT_CLASS(AProjectileBase, 2846891847);
